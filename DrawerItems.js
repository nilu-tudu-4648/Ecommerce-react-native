...
const DrawerItems = ({ navigation }) => {
  ...
  const drawerData = [
    {name:"My Account",navigation:NAVIGATION.PROFILE},
    {name:"My Cart",navigation:NAVIGATION.CART},
    {name:"My Orders",navigation:NAVIGATION.ORDERS},
    {name:"My Address",navigation:NAVIGATION.ADDRESS},
    {name:"My WishList",navigation:NAVIGATION.BAG},
  ]
  return (
